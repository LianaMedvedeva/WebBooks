...
class Book(models.Model):
    ...
    author = models.ManyToManyField('Author', help_text="Выберите автора", verbose_name="Автор кнниги")
...
class BookInstance(models.Model):
    book = models.ForeignKey('Book', on_delete=models.CASCADE, null=True, verbose_name="Название книги")
    inv_nom = models.CharField(max_length=20, null=True, help_text="Введите инвентарный номер эккземпляра", verbose_name="Инвентарный номер")
